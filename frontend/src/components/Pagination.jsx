...
const Pagination = ({ totalRows, rowsPerPage, currentPage, onPageChange }) => {
  ...
  return (
    <div className="flex items-center justify-between border-t border-gray-200 px-4 py-3 sm:px-6 mt-[-70px]">
            ...
            {[...Array(totalPages)].map((_, index) => (
              <button
                ...
                className={`relative inline-flex items-center px-4 py-2 text-sm font-semibold ${
                  index + 1 === currentPage ? 'bg-indigo-600 text-white' : 'text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50'
